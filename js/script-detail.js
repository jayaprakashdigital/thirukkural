...
/* ===== AUTO-GENERATION =====
   Deterministic prompt templates built from scene form fields.
   Rules:
   - Empty/missing fields are gracefully omitted (never leak "undefined").
   - Image prompt format: SUBJECT | SETTING | MOOD | CHARACTERS | STYLE | QUALITY.
   - Video prompt format: NARRATION | TRANSITION | CAMERA | QUALITY.
   - Lighting prompt format: TIME | WEATHER | LIGHT TYPE | TONES.
   - All prompts share the Studio Style for consistent Tamil-heritage visuals.
   - Negative prompt guidance is appended where image models support it. */
var STUDIO_STYLE = {
...
function sceneEditorHTML(scene, script) {
  ...
  return '<div class="sf-header"><h2>Scene ' + scene.sceneNumber + " \u2014 " + script.kuralId + '</h2></div>'
    ...
    + '<div class="sf-asset-card"><h4>Image</h4><div class="sf-preview-box">No image generated</div><div class="sf-asset-status">Pending</div></div>'
    + '<div class="sf-asset-card"><h4>Video</h4><div class="sf-preview-box">No video generated</div><div class="sf-asset-status">Pending</div></div>'
    + '<div class="sf-asset-card"><h4>Voice</h4><div class="sf-preview-box">No audio generated</div><div class="sf-asset-status">Pending</div></div>'
    + '</div></div>'

    // AI
    + '<div class="sf-tab-panel" data-panel="ai">'
    + '<div class="sf-grid">'
    + sfField("sf-generated-by", "Generated By", '<input type="text" id="sf-generated-by" value="' + esc(scene.generatedBy) + '" placeholder="e.g. Claude">', false)
    + sfField("sf-model-used", "Model Used", '<input type="text" id="sf-model-used" value="' + esc(scene.modelUsed) + '" placeholder="e.g. claude-sonnet">', false)
    ...
    + sfField("sf-prompt-version", "Prompt Version", '<input type="text" id="sf-prompt-version" value="' + esc(scene.promptVersion) + '" placeholder="e.g. v1.2">', false)
    + '</div></div>'
...
function readFormFields() {
  ...
  return {
    ...
    narrationVoice: g("sf-narration-voice"), voiceGender: g("sf-voice-gender"), voiceAge: g("sf-voice-age"), voiceEmotion: g("sf-voice-emotion"), speed: parseFloat(g("sf-speed")) || 1.0, pitch: parseFloat(g("sf-pitch")) || 1.0, language: g("sf-language"),
    ...
    generatedBy: g("sf-generated-by"), modelUsed: g("sf-model-used"), generationTime: g("sf-generation-time"), promptVersion: g("sf-prompt-version"),
