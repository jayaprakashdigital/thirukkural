...
const SCRIPT_SOURCE_STORIES = [
  ...
  },
  {
    ...
    title: "நன்மை தீமைக்கு அப்பால்",
    theme: "Praise of God",
    characters: ["Anbu (8)", "Paati"],
    location: "Thanjavur · Temple courtyard",
    hook: "Anbu lets the temple lamp go out in the wind. He's terrified God will punish him. Paati explains that true praise of God lifts you beyond both good and bad deeds.",
    story: "Anbu helps Paati light lamps around the temple courtyard. When a gust of wind blows out the main lamp, Anbu panics — he believes he has committed a sin and God will curse him. Paati laughs gently and explains that God is not a merchant weighing sins and merits. Those who truly praise God from the heart rise above both good and bad, like a lotus above muddy water. Anbu learns that devotion is not about fear, but freedom.",
    tamilDialogues: [
      "Anbu: 'Paati, விளக்கு அணைஞ்சுடுத்து! கடவுள் கோவிச்சுக்குவாரா?'",
      "Paati: 'இல்லை கண்ணு. கடவுள் நம்ம பயத்தைப் பார்க்கிறாரு, பாவத்தை இல்ல.'",
      "Anbu: 'நான் தப்பு செஞ்சிட்டேனா?'",
      "Paati: 'நன்மையும் தீமையும் இருளின் இரட்டைக் குழந்தைகள். இறைவனை உண்மையாகப் புகழ்பவர் இரண்டுக்கும் அப்பால் நிற்கிறார்.'"
    ],
    thiruvalluvarAppears: "The temple courtyard glows in the flickering lamplight. Thiruvalluvar appears beside the ancient neem tree, his white robes catching the golden glow. He smiles at Anbu with eyes that see beyond fear.",
